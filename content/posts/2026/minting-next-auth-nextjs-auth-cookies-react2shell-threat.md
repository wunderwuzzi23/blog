...
date: 2025-12-01T02:20:58-07:00  
draft: true  
...
If you had a public facing website vulnerable to `React2Shell` and you have not updated the `NEXTAUTH_SECRET` it might mean that an adversary gained access to the `NEXTAUTH_SECRET` and can mint arbitrary authentication tokens. 
