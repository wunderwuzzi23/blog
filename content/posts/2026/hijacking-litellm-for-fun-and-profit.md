...
3. **Model Distillation:** collect live responses as potential training data
4. **Response Forgery:** inject text or tool-call requests into responses sent to AI clients

Without appropriate monitoring, several of these can occur together and may go unnoticed.
